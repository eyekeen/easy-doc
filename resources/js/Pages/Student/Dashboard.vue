        ...
        <div class="status-container py-3" v-for="status in $page.props.statuses">
            <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
                <div class="overflow-hidden bg-white shadow-sm sm:rounded-lg">
                    ...
                    <h2 class="text-4xl font-extrabold dark:text-white border-b-4">{{ status.status }} </h2>
                    <div v-if="status.id == 1">
                        <div class="grid grid-cols-2 grid-rows-2 gap-4 mt-2" v-for="petition in $page.props.first_check">
                            <div
                                ...
                                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">кому отправлен: {{ petition.m_name }}</p>
                                <p class="mb-3 font-normal text-gray-700 dark:text-gray-400">Дата подачи: {{ petition.publish_date }}
                                </p>
