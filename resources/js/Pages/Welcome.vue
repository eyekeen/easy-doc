...
<template>
    ...
    <nav v-if="canLogin" className="bg-white shadow-lg border">
        <div className="container mx-auto px-4">
            <div className="flex justify-between items-center h-16">
                ...
                <div className="flex items-center space-x-4" v-if="$page.props.auth.user">
                ...
                <div className="flex items-center space-x-4" v-else>
