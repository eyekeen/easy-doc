...
<template>
    ...
    <nav v-if="canLogin" class="bg-white border-gray-200 dark:bg-gray-900 border">
            ...
            <div class="hidden w-full md:block md:w-auto" id="navbar-default">
                <ul
                    ...
                    <li v-if="$page.props.auth.user">
                        <a type="button" :href="route('student.dashboard')"
                            class="text-white 
                                bg-blue-700 
                    ...
                    <li v-if="$page.props.auth.user">
                        <a type="button" :href="route('logout')"
                            ...
                            text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-900">
                            Выйти
                        </a>
                    </li>
                    ...
                    <template v-else>
                        <li>
                            <a type="button" :href="route('login')"
                                ...
                                focus:ring-blue-300
                                hover:cursor-pointer 
                                font-medium rounded-lg text-sm px-5 py-2.5 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
                                Логин
                            </a>
                        </li>
                        <li>
                            <a type="button" v-if="canRegister" :href="route('register')"
                                class="text-white 
                                bg-blue-700 
                                hover:bg-blue-800 focus:ring-4 
                                focus:ring-blue-300
            ...
            <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6">
                <div class="max-w-screen-md mb-8 lg:mb-16">
                    <h2 class="mb-4 text-4xl tracking-tight font-extrabold text-gray-900 dark:text-white">
                        Сервис для электронной подачи заявлений и заявок
                    </h2>
                    ...
                    <div>
                        <div
                            ...
                            <svg class="w-5 h-5 text-primary-600 lg:w-6 lg:h-6 dark:text-primary-300"
                                ...
                                <path fill-rule="evenodd" stroke="#1C64F2"
                        ...
                        <p class="text-gray-500 dark:text-gray-400">Plan it, create it, launch it. Collaborate
                            seamlessly
                            with all the organization and hit your marketing goals every month with our marketing plan.
                        </p>
                    </div>
                    <div>
                        <div
                        ...
                        <div
                            ...
                            <svg class="w-5 h-5 text-primary-600 lg:w-6 lg:h-6 dark:text-primary-300"
                                ...
                                <path fill-rule="evenodd"
                                    ...
                                    clip-rule="evenodd" stroke="#1C64F2"></path>
                                <path
